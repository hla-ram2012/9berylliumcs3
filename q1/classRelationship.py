class FriendGroup:
    ...
    def add(self, friendgroupList):
        self.friendgroupList = friendgroupList.append(FriendinPisay)
    def displayInfo(self, friendgroupName, friendgroupInterest, friendgroupDisinterest, friendgroupRelationship, friendgroupStatus, friendgroupList):
        ...
        {displayList(self, friendgroupList)}''')
...
print("\nList of members in Friend Groups:")
fg1.displayList()
fg2.displayList()
